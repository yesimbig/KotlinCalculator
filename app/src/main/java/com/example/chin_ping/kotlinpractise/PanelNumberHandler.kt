...
class PanelNumberHandler{
    ...
    private lateinit var currentPanel: TextView
    ...
    fun setCurrentPanel(calculatePanel:TextView) {
        this.currentPanel = calculatePanel
    }

    fun setCalculateButtonController(calculateButtons: CalculateButtons){
    ...
    private fun setUpButtonState(){
        ...
        mCalculateButtons.setButtonState(currentDisplayOperator)
    }

    private fun setUpButtonCText(){
        mCalculateButtons.setButtonCText(isButtonC)
    }
